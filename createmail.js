const createMail = (username, email) => {
  return `
    ...
    <head>
        ...
        <title>Welcome to Flutter Club Organization</title>
        <!-- Stylesheet -->
        <style type='text/css'>
            * {
                margin: 0px;
        ...
        <div id='root'>
            <div id='header'>
                <div id='brand-logo-cont'>
                    <img id='brand-logo' src='http://github.com/flutterclub.png' alt='Flutter Club Logo'>
                </div>
                <h2>Welcome to Flutter Club Open Source<br>Organization</h2><br>
            </div>
            <hr class='divider' />
            <main>
                ...
                <p>With regards,<br>Flutter Club Open Source Organization</p>
            </main>
            <hr class='divider' />
            <footer>
                <h4>Find us on</h4>
                <a target='_blank' class='social-link' href='https://www.facebook.com/ieee.thapar/'>
                ...
                <a target='_blank' class='social-link' href='https://twitter.com/ieeethapar'>
                    <img src='https://user-images.githubusercontent.com/27884543/56142442-4e14ff00-5fbc-11e9-963b-34dc1560d9ab.png' class='image'>
                </a>
                <img src="https://img.icons8.com/ios/50/000000/thick-vertical-line-filled.png" class='divide'>
                <a target='_blank' class='social-link' href='https://www.linkedin.com/company/ieeethapar/'>
                    <img src='https://user-images.githubusercontent.com/27884543/56142509-6b49cd80-5fbc-11e9-95dd-5427fece767a.png' class='image'>
                </a>
                <br><br>
                <font size="0.5">If you have any questions, you can contact us at : <a href="mailto:flutter.ieeethapar.com">flutter.ieeethapar.com</a></font>
